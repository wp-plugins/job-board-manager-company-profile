...
// #################################################################	
	...
	public function job_bm_cp_companysingle_themes($themes = array()){

			$themes = array(
							'flat'=>'Flat',			
							);
			
			foreach(apply_filters( 'job_bm_cp_companysingle_themes', $themes ) as $theme_key=> $theme_name)
				{
					$theme_list[$theme_key] = $theme_name;
				}
	...
	public function job_bm_cp_companysingle_themes_dir($themes_dir = array()){
		
			$main_dir = job_bm_cp_plugin_dir.'themes/companysingle/';
			...
			foreach(apply_filters( 'job_bm_cp_companysingle_themes_dir', $themes_dir ) as $theme_key=> $theme_dir)
				{
					$theme_list_dir[$theme_key] = $theme_dir;
				}
	...
	public function job_bm_cp_companysingle_themes_url($themes_url = array()){
		
			$main_url = job_bm_cp_plugin_url.'themes/companysingle/';
			...
			foreach(apply_filters( 'job_bm_cp_companysingle_themes_url', $themes_url ) as $theme_key=> $theme_url)
				{
					$theme_list_url[$theme_key] = $theme_url;
				}
	...
	public function job_bm_cp_share_plugin()
		{
...
<iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwordpress.org%2Fplugins%2Fresumes-builder%2F&amp;width&amp;layout=standard&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=80&amp;appId=652982311485932" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:80px;" allowTransparency="true"></iframe>
            ...
            <div class="g-plusone" data-size="medium" data-annotation="inline" data-width="300" data-href="<?php echo job_bm_cp_share_url; ?>"></div>
            
            <br />
            <br />
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo job_bm_cp_share_url; ?>" data-text="<?php echo job_bm_cp_plugin_name; ?>" data-via="ParaTheme" data-hashtags="WordPress">Tweet</a>
